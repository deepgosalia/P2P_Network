...
public class Peer {
    ...
    private static int serverThreadPort = 5001;
    private static int ownThreadPortNo = 5002;
...
//            }
        ...
        peer2.PeerAsClient peerAsClient = new peer2.PeerAsClient(serverThreadPort, peerList,mapFileMeta);
        Thread downloadingThread = new Thread(peerAsClient);
        downloadingThread.start();

        //Uploading Thread (Server)
        peer2.PeerAsServer peerAsServer = new peer2.PeerAsServer();
        peerAsServer.main(ownThreadPortNo, 3, peerList);
